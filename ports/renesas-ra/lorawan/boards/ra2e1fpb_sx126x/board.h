...
#define RA2E1FPB_SX126x      // FPB-RA2E1(RTK7FPA2E1S00001BE) + Semtech SX126x board

#if defined(RA2E1FPB_SX126x)
#define R7FA2E1A9
#endif
 ...
 */
#define RADIO_RESET                 (P0_0)
#define RADIO_MOSI                  (P1_1)
#define RADIO_MISO                  (P1_0)
#define RADIO_SCLK                  (P1_2)
#define RADIO_NSS                   (P1_13)
#define RADIO_BUSY                  (P1_4)
#define RADIO_DIO_1                 (P3_2)

#if defined(RP_CONTROL_ANTSW_BY_MCU)
#define ANT_SWITCH_POWER            (P4_3)
#endif

#define RP_RADIO_DEVICE_SEL         (P0_2)
#define RP_RADIO_XTAL_SEL           (P0_3)
