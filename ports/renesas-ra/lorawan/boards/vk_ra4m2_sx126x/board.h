...
#define VK_RA4M2_SX126x      // VK_RA4M2 + Wio-SX1262 radio module
 ...
 */
/* VK_RA4M2 uses a fixed Wio-SX1262 configuration. Do not define RP_DETECT_BOARD_CONFIG. */
...
#define DEFAULT_POWER_SELECT        RADIO_HIPOWER_SEL
#endif
...
/*!
 * Authority pin map for the VK_RA4M2 + SX126x board layer. SPI and timer
 * peripheral ownership is established by Python objects passed as spi=/timer=.
 */
#define RADIO_RESET                 (P0_1)
#define RADIO_MOSI                  (P1_9)
#define RADIO_MISO                  (P1_10)
#define RADIO_SCLK                  (P1_11)
#define RADIO_NSS                   (P2_6)
#define RADIO_BUSY                  (P0_2)
#define RADIO_DIO_1                 (P0_15)

#if defined(RP_CONTROL_ANTSW_BY_MCU)
#define ANT_SWITCH_POWER            (P1_0)
#endif
...
/*!
 * \brief Compatibility no-op: DIO1 IRQ is owned by sx126x-board.c Pin.irq/extint.
 */
...
/*!
 * \brief Compatibility no-op: Python-owned timer controls its own IRQ.
 */
