...
if not m.is_joined():
    print('[FAIL] TC03_V4 not_joined_after_nvm_restore')
    raise SystemExit
...
print('[%s] TC03_V4 received_count=%d got_21=%s got_22=%s got_23=%s preview=%s events=%d' %
