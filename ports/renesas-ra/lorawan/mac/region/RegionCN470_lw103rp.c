...
static uint32_t RegionCN470CalcDownlinkFrequency( uint8_t channel, uint32_t frequency,
                                                  uint32_t stepwidth )
{
...
PhyParam_t RegionCN470GetPhyParam( GetPhyParams_t* getPhy )
{
    ...
    switch( getPhy->Attribute )
    {
        ...
        {
            phyParam.Value = RegionCN470CalcDownlinkFrequency( getPhy->Channel,
...
void RegionCN470InitDefaults( InitDefaultsParams_t* params )
{
    ...
    switch( params->Type )
    {
        case INIT_TYPE_INIT:
        {
            ...
            params->DefaultRx2Frequency      = CN470_RX_WND_2_FREQ;                // PHY_DEF_RX2_FREQUENCY
...
void RegionCN470ComputeRxWindowParameters( int8_t datarate, uint8_t minRxSymbols, uint32_t rxError, RxConfigParams_t *rxConfigParams )
{
    ...
    rxConfigParams->Datarate = R_MIN( datarate, CN470_RX_MAX_DATARATE );
...
#endif  // (REGION_VERSION <= REGION_VERSION_1_0_3_x)
#endif  // REGION_CN470
