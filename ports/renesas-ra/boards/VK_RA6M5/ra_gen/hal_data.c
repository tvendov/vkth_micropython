...
static ospi_timing_setting_t g_ospi_ram0_timing_settings = {
    ...
    .cs_pullup_lag = OSPI_COMMAND_CS_PULLUP_CLOCKS_3, .cs_pulldown_lead =
...
static const ospi_extended_cfg_t g_ospi_ram0_extended_cfg = { .channel =
                                                                  ...
                                                                  OSPI_DEVICE_RAM, .data_latch_delay_clocks = 0x30,
                                                              .om_dqs_enable_counter_dopi = 7, .om_dqs_enable_counter_sopi = 0, /* Unused by OSPI RAM */
                                                              .single_continuous_mode_read_idle_time = 3,
                                                              .single_continuous_mode_write_idle_time = 3,
...
// Locally-administered MAC.  The lower 5 octets are filled at boot from the
// MCU's 16-byte unique ID (see eth_init in ports/renesas-ra/eth.c).  The
// initial value here is a fallback in case the UID read fails.
uint8_t g_ether0_mac_address[6] = { 0x02, 0x56, 0x4B, 0x36, 0x4D, 0x35 };
