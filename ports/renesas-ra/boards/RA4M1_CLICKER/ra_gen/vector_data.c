...
/* Do not build these data structures if no interrupts are currently allocated because IAR will have build errors. */
    ...
    [13] = sci_uart_rxi_isr,         /* SCI2 RXI (Received data full) */
    ...
    [16] = sci_uart_eri_isr,         /* SCI2 ERI (Receive error) */
	    ...
	    [20] = iic_master_eri_isr,         /* IIC0 ERI (Transfer error) */
		    [21] = iic_slave_rxi_isr,          /* IIC1 RXI (Receive data full, slave mode) */
		    [22] = iic_slave_txi_isr,          /* IIC1 TXI (Transmit data empty, slave mode) */
		    [23] = iic_slave_tei_isr,          /* IIC1 TEI (Transmit end, slave mode) */
		    [24] = iic_slave_eri_isr,          /* IIC1 ERI (Transfer/error, slave mode) */
    ...
    [13] = BSP_PRV_IELS_ENUM(EVENT_SCI2_RXI),         /* SCI2 RXI (Received data full) */
