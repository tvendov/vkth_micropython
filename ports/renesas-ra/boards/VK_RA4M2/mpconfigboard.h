...
#define MICROPY_HW_MCU_SYSCLK       100000000  // Real ICLK: XTAL 16MHz / PLL_DIV(4) * PLL_MUL(25) / ICLK_DIV(2) = 100MHz
#define MICROPY_HW_MCU_PCLK         50000000   // Real PCLKB: 100MHz / PCLKB_DIV(2) = 50MHz
