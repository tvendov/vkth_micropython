...
Тази книга е направена върху реално наличния пакет от `58` примерни `.py` файла за `VK_RA4M2`.
...
- Глава 37. Основи на asyncio
- Глава 38. asyncio Event синхронизация
...
#### Нататък
След това мини към следващата глава, „Основи на asyncio“, за да надградиш текущата идея в естествената ѝ следваща стъпка.
...
- всички `58` примерни файла са споменати изрично
