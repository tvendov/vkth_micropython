...
Тази книга е направена върху реално наличния пакет от `54` примерни `.py` файла за `VK_RA4M2`.
...
- Глава 24. Управление на паметта в MicroPython
- Глава 25. `machine` модулът и порт-специфично поведение

### Част VII: Индикация и входни матрици
- Глава 26. Динамична 7-сегментна индикация и матрично сканиране

### Част VIII: FSM като начин на мислене
- Глава 27. Минимална FSM и таблична FSM
- Глава 28. FSM с timeout
- Глава 29. Conditions vs Events
- Глава 30. Guard функции
- Глава 31. Приоритети и event queue
- Глава 32. Tickless timers и sleep идея

### Част IX: Реален пример
- Глава 33. Управление на осветление и вентилация за баня
- Глава 34. Декомпозиция на две FSM

### Част X: UART комуникация
- Глава 35. Базова UART комуникация

### Част XI: asyncio като учебна секция
- Глава 36. Основи на asyncio
- Глава 37. asyncio Event синхронизация
...
- всички `54` примерни файла са споменати изрично
