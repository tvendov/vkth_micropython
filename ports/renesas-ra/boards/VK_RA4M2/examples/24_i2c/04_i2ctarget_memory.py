# Пример: I2CTarget с memory-backed буфер в MicroPython на VK_RA4M2.
...
# Бележка: Този пример изисква външен I2C master, който да чете и пише към адрес 0x42.
...
print("=== I2CTarget с memory-backed буфер ===")  # Печатаме заглавие на примера.
print("Обектът е", target)  # Печатаме target обекта и адреса му.
print("Начално съдържание на буфера:", list(memory_buffer))  # Показваме началното съдържание на паметта.

print("Свържете външен I2C master към адрес 0x42, за да четете и пишете в този буфер.")  # Обясняваме как се използва примерът в реална схема.

print("Примерът за I2CTarget приключи.")  # Завършваме примера.
