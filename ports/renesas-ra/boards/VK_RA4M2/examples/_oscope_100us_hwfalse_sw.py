...
print("=== 100 us: soft vs hard=False ===")
print("machine.freq() =", machine.freq())
print("P100 = Timer(-1) soft")
print("P302 = Timer(1) hard=False")
print("Target: 10 kHz square wave on both pins")
...
hard_timer.init(freq=CALLBACK_HZ, callback=hard_cb, hard=False)
print("hardware timer started with hard=False")
