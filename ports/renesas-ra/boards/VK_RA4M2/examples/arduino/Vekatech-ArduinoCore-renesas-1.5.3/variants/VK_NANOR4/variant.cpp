...
extern "C" const PinMuxCfg_t g_pin_cfg[] = { 
  ...
  { BSP_IO_PORT_02_PIN_14,    P214   }, /* (28) Din1/XCout */
  { BSP_IO_PORT_05_PIN_00,    P500   }, /* (29) A8  */
  { BSP_IO_PORT_05_PIN_01,    P501   }, /* (30) A9  */
  { BSP_IO_PORT_05_PIN_02,    P502   }, /* (31) A10 */
  { BSP_IO_PORT_00_PIN_12,    P012   }, /* (32) A11 */

  { BSP_IO_PORT_02_PIN_00,    P200   }, /* (33) Din0 */

  { BSP_IO_PORT_04_PIN_02,    P402   }, /* (34) D14 */
  { BSP_IO_PORT_01_PIN_13,    P113   }, /* (35) D15 */
  { BSP_IO_PORT_00_PIN_13,    P013   }, /* (36) A12 */

  { BSP_IO_PORT_00_PIN_15,    P015   }, /* (37) A13 */

  { BSP_IO_PORT_00_PIN_11,    P011   }, /* (38) A14 */

  { BSP_IO_PORT_02_PIN_15,    P215   }, /* (39) Din2/XCin */

  { BSP_IO_PORT_02_PIN_05,    P205   }, /* (40) TX0/MOSI0/SDA0 */
  { BSP_IO_PORT_02_PIN_06,    P206   }  /* (41) RX0/MISO0/SCL0 */

  /*{ BSP_IO_PORT_04_PIN_08,    P408   },*/ /* (36) NC */
};
