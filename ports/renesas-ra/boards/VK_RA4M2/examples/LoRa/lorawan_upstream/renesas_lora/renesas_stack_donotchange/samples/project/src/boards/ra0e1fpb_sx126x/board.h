...
#define RA0E1FPB_SX126x      // FPB-RA0E1(RTK7FPA0E1S00001BJ) + Semtech SX126x board

#if defined(RA0E1FPB_SX126x)
#define R7FA0E107
#endif
 ...
 */
#define RADIO_RESET                 (P0_14)
#define RADIO_MOSI                  (P2_13)
#define RADIO_MISO                  (P2_12)
#define RADIO_SCLK                  (P4_7)
#define RADIO_NSS                   (P1_3)
#define RADIO_BUSY                  (P2_1)
#define RADIO_DIO_1                 (P2_8)

#if defined(RP_CONTROL_ANTSW_BY_MCU)
#define ANT_SWITCH_POWER            (P1_9)
#endif

#define RP_RADIO_DEVICE_SEL         (P0_12)
#define RP_RADIO_XTAL_SEL           (P0_9)
