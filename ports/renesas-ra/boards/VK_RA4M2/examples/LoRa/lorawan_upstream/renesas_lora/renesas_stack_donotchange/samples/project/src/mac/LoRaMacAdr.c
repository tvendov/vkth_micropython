...
static bool CalcNextV10X( CalcNextAdrParams_t* adrNext, int8_t* drOut, int8_t* txPowOut, 
                          uint8_t* nbTransOut, uint32_t* adrAckCounter )
{
    ...
    *adrAckCounter = adrNext->AdrAckCounter;
    ...
    if( adrNext->AdrEnabled == true )
    {
        ...
        datarate = R_MAX( datarate, minTxDatarate );

#if (LORAMAC_VERSION < LORAWAN_VERSION_1_0_4)  // LV1.0.3
...
#endif
    {
        bRet = CalcNextV10X( adrNext, drOut, txPowOut, nbTransOut, adrAckCounter );
    }
