...
//-----------------------------------------------------
// prototypes: app_fuota_at_proc.c
//-----------------------------------------------------
/*!
 * @fn
 * AT+FUOTASTART: Start FUOTA
 */
extern AtResultCode_t AppAtFuotaStartAct( void *p );

/*!
 * @fn
 * AT+FUOTASTART: Stop FUOTA
 */
extern AtResultCode_t AppAtFuotaStopAct( void *p );

/*!
 * @fn
 * AT+FUOTAGET: Get FUOTA IB
 */
extern AtResultCode_t AppAtFuotaIbGet( void *p );

/*!
 * @fn
 * AT+FUOTASET: Set FUOTA IB
 */
extern AtResultCode_t AppAtFuotaIbSet( void *p );

/*!
 * @fn
 * AT+FUOTAUPDT: Start F/W update
 */
extern AtResultCode_t AppAtFuotaUpdateAct( void *p );
 ...
 */
extern AtResultCode_t AppAtFuotaCommandInput( void *p );
 ...
 * Check FUOTA_Status
 */
extern AtResultCode_t AppAtFuotaCommandResult( void *p );
#endif  // DEBUG_FUOTA
#endif
...
#endif
#if defined(FUOTA_ENABLED)
    { NULL,            NULL,  AppAtFuotaStartAct,  11, (int8_t *)"+FUOTASTART" },
    { NULL,            NULL,  AppAtFuotaStopAct,   10, (int8_t *)"+FUOTASTOP"  },
    { AppAtFuotaIbGet, NULL,  NULL,                 9, (int8_t *)"+FUOTAGET"   },
    { AppAtFuotaIbSet, NULL,  NULL,                 9, (int8_t *)"+FUOTASET"   },
    { NULL,            NULL,  AppAtFuotaUpdateAct, 10, (int8_t *)"+FUOTAUPDT"  },
#ifdef DEBUG_FUOTA
    { AppAtFuotaCommandInput, AppAtFuotaCommandResult, NULL, 9, (int8_t *)"+FUOTACMD" },
#endif
#endif
};
#endif
