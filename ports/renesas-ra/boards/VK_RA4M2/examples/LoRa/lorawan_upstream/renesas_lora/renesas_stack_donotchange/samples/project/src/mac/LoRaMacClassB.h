...
typedef enum eBeaconState
{
     ...
     */
    BEACON_STATE_HALT,
    BEACON_STATE_HALT_TIMEOUT,
    BEACON_STATE_HALT_LOST,
    /*!
...
typedef struct sPingSlotContext
{
    ...
    uint16_t PingOffset;
    /*!
     * Difference before and after enlarging WindowTimeout and WindowOffset
     */
    int32_t  PingSlotRxEnlargeWindowOffset;
    uint32_t PingSlotRxEnlargeWindowTimeout;
...
typedef struct sBeaconContext
{
     ...
     * Difference before and after enlarging WindowTimeout and WindowOffset
     */
    uint32_t BeaconRxEnlargeWindowTimeout;
    int32_t  BeaconRxEnlargeWindowOffset;
    /*!
    ...
    /*!
     * The time of the last system time setting
     */
    TimerTime_t LastSystimeSetTimeMs;
    bool LastSystimeSetIsBeacon;
...
/*!
 * \brief Stops the timers for the multicast RX slots. This includes the
 *        timers for multicast slots.
 */
...
/*!
 * \brief Starts the timers for the multicast RX slots.
 */
...
bool LoRaMacClassBIsReadyRxBeacon( void );
