 ...
 */
/*
    (C) 2022 Renesas Electronics Corporation.
...
bool RegionCN470B20VerifyRfFreq( uint32_t freq )
{
    ...
    // Downstream group 1
    group1Status = RegionCN470VerifyFrequencyGroup( freq, CN470_B20_FIRST_RX1_CHANNEL,
                                                    CN470_B20_LAST_RX1_CHANNEL,
                                                    CN470_B20_STEPWIDTH_RX1_CHANNEL );
    // Downstream group 2
    group2Status = RegionCN470VerifyFrequencyGroup( freq, CN470_B20_FIRST_RX2_CHANNEL,
