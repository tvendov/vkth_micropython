...
#define AS923_JAPAN_TX_MAX_DATARATE                 DR_5
...
#define AS923_JAPAN_RX_MAX_DATARATE                 DR_5
 ...
 */
#if !defined(AS923_DEFAULT_UPLINK_DWELL_TIME)
#define AS923_DEFAULT_UPLINK_DWELL_TIME             1       // Note: Need to set to one for certificaion test
#endif

/*!
 * Default downlink dwell time configuration
 */
#if !defined(AS923_DEFAULT_DOWNLINK_DWELL_TIME)
#define AS923_DEFAULT_DOWNLINK_DWELL_TIME           1       // Note: Need to set to one for certificaion test
#endif
...
#define AS923_JAPAN_DEFAULT_MAX_EIRP                16.0f
...
#define AS923_JAPAN_MIN_RF_FREQUENCY                920600000

#define AS923_MAX_RF_FREQUENCY                      928000000
#define AS923_JAPAN_MAX_RF_FREQUENCY                923400000

/*!
 * Minimum/maximum frequency
 */
#define AS923_FREQ_OFFSET                           0
#define AS923_JAPAN_FREQ_OFFSET                     0
#if (REGION_VERSION >= REGION_VERSION_2_1_0_2)
#define AS923_GROUP1_FREQ_OFFSET                    AS923_FREQ_OFFSET
#define AS923_GROUP2_FREQ_OFFSET                    ( ( ~( 0xFFFFB9B0 ) + 1 ) * 100 )  // -1.8MHz
#define AS923_GROUP3_FREQ_OFFSET                    ( ( ~( 0xFFFEFE30 ) + 1 ) * 100 )  // -6.6MHz
#endif
#if (REGION_VERSION >= REGION_VERSION_2_1_0_3)
#define AS923_GROUP4_FREQ_OFFSET                    ( ( ~( 0xFFFF1988 ) + 1 ) * 100 )  // -5.9MHz
#endif
