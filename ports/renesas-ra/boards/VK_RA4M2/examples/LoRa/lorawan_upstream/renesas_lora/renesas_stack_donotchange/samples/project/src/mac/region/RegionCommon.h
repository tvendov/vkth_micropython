...
/*!
 * \brief Computes the RX window timeout and the RX window offset for beacon.
 *
 * \param [IN] tSymbolInUs Symbol timeout.
 *
 * \param [IN] minRxSymbols Minimum required number of symbols to detect an Rx frame.
...
/*!
 * \brief This is an internal function to correct symbol timeout to match the sx126x.
 * 
 * \param [IN] symbolTimeout symbol timeout
 *
 * \retval Returns the corrected symbol timeout.
 */
