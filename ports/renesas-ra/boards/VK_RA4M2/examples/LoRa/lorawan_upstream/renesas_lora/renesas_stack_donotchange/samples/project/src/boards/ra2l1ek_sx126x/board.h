...
#define RA2L1EK_SX126x      // EK-RA2L1(RTK7EKA2L1S00001BE) + Semtech SX126x board

#if defined(RA2L1EK_SX126x)
#define R7FA2L1AB
#endif
...
#define RADIO_BUSY                  (P4_0)
#define RADIO_DIO_1                 (P1_11)

#if defined(RP_CONTROL_ANTSW_BY_MCU)
#define ANT_SWITCH_POWER            (P1_9)
#endif
