 ...
 */
  ...
  *
  * Changes:
  *   - Added compile option MBEDTLS_MD_LIGHT, SHA1_OPT_ROM, MD_HMAC_SHA1_ONLY, MD_HMAC_SHA1_ALLOC_CTX_IN_STACK
 */
...
#define SHA1_OPT_ROM        // Added to reduce ROM size. Replace the macros to the functions if enabled.
#define MD_HMAC_SHA1_ONLY
#define MD_HMAC_SHA1_ALLOC_CTX_IN_STACK      // Added to allocate context area from the stack for MD_SHA1
#endif
