...
static SysTime_t SysTimeDeltaTime = { 0, 0};
...
void SysTimeSet( SysTime_t sysTime )
{
    ...
    SysTimeDeltaTime = deltaTime;       // save delta tiime
}
...
SysTime_t SysTimeGet( void )
{
    ...
    deltaTime = SysTimeDeltaTime;       // restore delta tiime
...
TimerTime_t SysTimeToMs( SysTime_t sysTime )
{
    ...
    return (TimerTime_t)calendarTime.Seconds * (TimerTime_t)1000 + (TimerTime_t)calendarTime.SubSeconds;
}
...
SysTime_t SysTimeGetDeltaTime( void )
{
    return SysTimeDeltaTime;
}
