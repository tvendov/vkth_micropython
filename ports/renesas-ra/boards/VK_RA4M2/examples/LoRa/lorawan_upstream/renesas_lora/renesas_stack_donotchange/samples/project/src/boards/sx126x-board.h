...
/*!
 * \brief Initializes configurations and variables that are maintained in 
 *        sx126x-board.c
 */
 ...
 * \retval PaSelect PA (Power Amp) configuration value
 */
uint8_t SX126xGetPaSelect( void );

/*!
 * \brief Sets the board PA selection configuration
 * \param [IN] paType PA (Power Amp) configuration value
 */
void SX126xSetPaSelect( uint8_t paType );

/*!
 * \brief Gets the board clock selection configuration
 * \retval Clock oscillator configuration value
 */
uint8_t SX126xGetClockSelect( void );

/*!
 * \brief Sets the board clock selection configuration
 * \param [IN] clock oscillator configuration value
 */
