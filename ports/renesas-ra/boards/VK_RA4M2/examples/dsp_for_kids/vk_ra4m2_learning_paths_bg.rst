...
- :ref:`renesas-ra_vk-ra4m2_signal_processing_course_bg` за планирания курс по елементарна сигнална обработка
...
2. :ref:`renesas-ra_vk-ra4m2_signal_processing_course_bg`
3. ``examples/dac_firmware_probe.py``
4. ``examples/retro_synth.py``
5. ``examples/dac_retro_sfx.py``
6. ``examples/dac_retro_music.py``
...
- ако искате структурирана audio/DSP учебна линия: :ref:`renesas-ra_vk-ra4m2_signal_processing_course_bg`
