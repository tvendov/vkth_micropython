...
Ако искате отделна, по-структурирана рамка за елементарна сигнална обработка,
която свързва ``DAC``, ``audiomixer`` и ``CMSIS-DSP``, вижте и
:ref:`renesas-ra_vk-ra4m2_signal_processing_course_bg`.

Ако искате консервативен статус какво вече е хардуерно потвърдено и какво още
остава за бордови тестове, вижте
:ref:`renesas-ra_vk-ra4m2_validation_matrix_bg`.
...
Ако целта ви е не само ретро звук, а и учебна последователност по сигнали,
филтри и честотен анализ, следващата естествена страница е
:ref:`renesas-ra_vk-ra4m2_signal_processing_course_bg`.
