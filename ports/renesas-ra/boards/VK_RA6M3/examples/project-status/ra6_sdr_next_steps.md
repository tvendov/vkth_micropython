...
| --- | --- | --- |
| Native TX AF 100 Hz–избрана горна граница; BASE | Реализирано; C host PASS | Най-лош ISR бюджет и смяна на профил на платката |
| MIC / FILE / GEN към AM / USB / LSB | Общ C път; host проверява и scope входа | Цифров HIL след отделно качване |
| HOME хоризонтален избор / TX BACKEND AF upper | Реализирано; callback тестове PASS | Физически touch/layout и FILE continuity |
| PWR 0–100% | Управлява наличния I/Q размах; host PASS | Аналогов размах; не се твърдят ватове |
| RX/TX параметри | Отделни bw/txbw, VOL/txlevel; host roundtrip PASS | Dataflash readback след връщане RX |
| RadioOnly firmware + MPY | Build PASS; НЕ е качено | Качване при следваща заявка; без тестови файлове във flash |
...
Допълнителният GUI heap и времето на платката остават НЕИЗМЕРЕНИ.
