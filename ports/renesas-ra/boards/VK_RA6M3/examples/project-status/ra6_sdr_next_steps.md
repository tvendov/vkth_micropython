...
- [x] Общо C ядро за генериране и разпознаване на избран тон, без sample heap.
  DDS: build/HIL PASS. Детектор: host PASS, още не е включен в RX/ELF.
- [ ] Отделна сигнализация за репитър: TX тон се смесва с гласа, RX детектор
...
- [ ] Уточняване на протоколите: CTCSS/1750 Hz като първа възможност;
  DTMF и DCS са отделни реализации, не се обявяват за налични.
- [ ] RX индикация и опционално отваряне на звука само при разпознат тон;
  подразбиране OFF, без скрито заглушаване на съществуващия приемник.
