...
## Текущ статус — 2026-09-09: плавни GEN преходи качени и проверени
...
- [ ] Следващо разработване: отделен репитърен тон, смесен с MIC/R:xx,
  и детектор при наличие на реч. Да се уточни първият протокол/честоти;
...
След тези проверки: отделен тон за репитър, смесен с гласа, и RX
разпознаване в присъствие на реч. GEN заменя гласа и не е тази функция.
...
- [ ] Опционално отваряне на звука само при разпознат тон; подразбиране OFF.
